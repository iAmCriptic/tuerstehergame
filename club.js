...
const visitors = [
  // Drug Dealer
  { src: './media/visitors/visitor_club/01.png', patient: false, desired: false, answers: [ //Desired bestimmt ob die Person rein darf wenn false wird Score tiefer gestellt, Patient Bestimmt die anzahl der Fragen false=4 true=6
  ...
  // Footballer
  { src: './media/visitors/visitor_club/02.png', patient: true, desired: true, answers: [
  ...
  // Dog Owner
  { src: './media/visitors/visitor_club/03.png', patient: true, desired: false, answers: [
  ...
  // Homeless
  { src: './media/visitors/visitor_club/04.png', patient: false, desired: false, answers: [
  ...
  // Business Woman
  { src: './media/visitors/visitor_club/05.png', patient: true, desired: true, answers: [
    ...
    // Old Man
    { src: './media/visitors/visitor_club/06.png', patient: true, desired: true, answers: [
    ...
    // Cool guy
    { src: './media/visitors/visitor_club/07.png', patient: true, desired: true, answers: [
      ...
      // Cowgirl
    { src: './media/visitors/visitor_club/08.png', patient: false, desired: false, answers: [
      ...
      // Cowboy
    { src: './media/visitors/visitor_club/09.png', patient: false, desired: false, answers: [
      ...
      // Vorlage
    { src: './media/visitors/visitor_club/10.png', patient: false, desired: true, answers: [
      ...
      "Ich bin aktuell arbeitslos.", // Beruf
        ...
        // Vorlage
    { src: './media/visitors/visitor_club/11.png', patient: true, desired: true, answers: [
      ...
      "Nach was sieht's wohl aus.", // Beruf
        ...
        // Vorlage
    { src: './media/visitors/visitor_club/12.png', patient: false, desired: true, answers: [
      ...
      "Business Manager.", // Beruf
        ...
        // Vorlage
    { src: './media/visitors/visitor_club/13.png', patient: true, desired: false, answers: [
      "Hmm...", // initiale Antwort, sollte auf (Un-)Geduld hinweisen
      "Google doch.", // Alter
      "...", // Habseligkeiten
      "...", // Clubwissen
      ...
      "...", // Beruf
        ...
        // Vorlage
    { src: './media/visitors/visitor_club/14.png', patient: true, desired: false, answers: [
    ...
    // Vorlage
    { src: './media/visitors/visitor_club/15.png', patient: true, desired: false, answers: [
      ...
      "Nichts hab aber ein Werbeposter gesehen.", // Clubwissen
    ...
    // Vorlage
    { src: './media/visitors/visitor_club/16.png', patient: false, desired: true, answers: [
    ...
    // Vorlage
    { src: './media/visitors/visitor_club/17.png', patient: false, desired: false, answers: [
    ...
    // Vorlage
    { src: './media/visitors/visitor_club/18.png', patient: false, desired: true, answers: [
    ...
    // Vorlage
    { src: './media/visitors/visitor_club/19.png', patient: false, desired: false, answers: [
    ...
    // Vorlage
    { src: './media/visitors/visitor_club/20.png', patient: false, desired: true, answers: [
    ...
    // Vorlage
    { src: './media/visitors/visitor_club/21.png', patient: true, desired: false, answers: [
      "Ich höre.", // initiale Antwort, sollte auf (Un-)Geduld hinweisen
      "Genau will ich das nicht sagen, aber auf jeden fall deutlich über 18.", // Alter
      "Ein paar Bier.", // Habseligkeiten
      "Na Club halt.", // Clubwissen
      "Spaß, was denn sonst.", // Besuchsgrund
      "Ich habe ein bisschen Schnupfen.", // Gesundheit
      "Ja.", // wiederholter Besuch
      "Ich bin Bäckerin.", // Beruf
    ]},
    // Vorlage
    { src: './media/visitors/visitor_club/22.png', patient: false, desired: true, answers: [
...
const questions = [ //alle fragen, die zu verfügung stehen
  ...
  "Warum bist du hier?",
  "Wie fühlst du dich denn heut so?",
